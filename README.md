...
* ⭐ **Ratings & Popular Movies**
  عرض أشهر الأفلام أو أعلى التقييمات (لو API بيدعم ده).
...
لو مشروعك بيستخدم API Key، ضيفه هنا:
...
> ![Dark](Assets/screenshots/home-dark.png)
...
> ![Dark](Assets/screenshots/navbar-dark.png)
